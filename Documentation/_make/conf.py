# -*- coding: utf-8 -*-
#
# Task Queue documentation build configuration file, created by
# TYPO3 extension sphinx on Mon, 20 Oct 2014 12:36:39 +0200.
#
...
project = u'Task Queue'
copyright = u'2014, Eike Starkmann'
...
htmlhelp_basename = 'taskqueuedoc'
...
latex_documents = [
    ('Index', 'taskqueue.tex', u'Task Queue',
     u'Eike Starkmann', 'manual'),
]
...
texinfo_documents = [
    ('Index', 'taskqueue', u'Task Queue',
     u'Eike Starkmann', 'Task Queue', 'One line description of project.',
     'Miscellaneous'),
]
